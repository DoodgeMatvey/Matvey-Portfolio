...
# Матвей Горский✌
  ...
  Я сделал этот сайт, чтобы показать свои навыки в дизайне, использование различных плагинов, а также адаптивность и кросс-браузерную       вёрстку.
  ...
  - HTML5 (BEM), CSS3 (flexbox, анимация, адаптивность, кроссбраузерность), SASS / SCSS;
